...
function Yhteenveto ({lomakkeentiedot}){
...
<Card sx={{ maxWidth: 400 }} style={{margin:"2em"}}>
      ...
      <Typography variant='h6'>
        ...
        {(lomakkeentiedot.current.puhelin)?
                  <Typography>Puhelinnumero: {lomakkeentiedot.current.puhelin}</Typography>
                  :
                  null
          }
          {(lomakkeentiedot.current.email)?
        <Typography>Sähköposti: {lomakkeentiedot.current.email}<br/><br/></Typography>
        :
        null
        }
        <Typography>Toimitustapa: {lomakkeentiedot.current.lahetys}
          </Typography>
