...
import { useState } from 'react';
        ...
        function Tilaus ({lomakkeentiedot}){
        ...
        />
            ...
            margin: "1.5em",
                ...
                <FormLabel id="radiobutton"
                style={{margin:"1em",}}
                >Tilauksen toimitus:</FormLabel>
                        <RadioGroup
                            row
                            ...
                            style={{maxWidth: 500,}}
                        >
                            <FormControlLabel value="Kotiovelle" control={
                            <Radio name="lahetys"
                            onChange={inputHandler}/>}
                            label="Kotiovelle" />

                            <FormControlLabel value="Postin pakettiautomaatti" control={
                            <Radio
                            name="lahetys"
                            onChange={inputHandler}
                             />} label="Postin pakettiautomaatti" />

                            <FormControlLabel value="Postin toimipaikka" control={
                            <Radio
                            name="lahetys"
                            onChange={inputHandler}
                        ...
                        <FormHelperText error={Boolean(virheilmoitus.lahetys)}>{virheilmoitus.lahetys}</FormHelperText>
            </FormControl>
            ...
            <div style={{display:"flex",
                ...
                maxDateTime={maxAika}
                error={Boolean(virheilmoitus.erapaiva)}
                renderInput={(params) => 
                <TextField {...params} 
                sx={{ m: 1 }} 
                helperText={virheilmoitus.erapaiva}/>}
                />
                </div>
